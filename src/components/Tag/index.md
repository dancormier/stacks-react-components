...
<Tag href="#" hasDismiss>JavaScript</Tag>
<Tag
  href="#"
  sponsor={{
...
<Tag className="is-selected" href="#" hasDismiss>razor</Tag>
```
...
<Tag href="#" variant="moderator" hasDismiss>status-bydesign</Tag>
...
<Tag href="#" variant="required" hasDismiss>feature-request</Tag>
...
<Tag href="#" variant="muted" hasDismiss>netscape</Tag>
<Tag
  href="#"
  variant="muted"
  sponsor={{
